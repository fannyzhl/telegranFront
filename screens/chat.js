                    ...
                    <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                        ...
                        <View style={{ flexDirection: "row", alignSelf: "center", justifyContent: "space-between" }}>
                            ...
                            <View style={{ alignSelf: "flex-start" }}>
                                ...
                                <Text style={{ fontSize: 15, fontStyle: 'italic', color: '#FFF' }}>{navigation.title}</Text>
            ...
            headerRight: (
                <View style={{ flex: 1 }}>
                    <View style={{ flexDirection: "row" }}>
                        ...
                        <TouchableOpacity onPress={()=>{navigation.initiateCall('video');}}>

                            <MaterialCommunityIcons style={{ padding: 8 }} name="video" size={32} color="white"/>

                        </TouchableOpacity>

                        <TouchableOpacity onPress={()=>{navigation.initiateCall('audio');}}>
